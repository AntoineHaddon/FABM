...
! Declare horizontal diagnostic variables
      type (type_horizontal_diagnostic_variable_id) :: id_chl,id_chlia,id_fgrow,id_fgraze,id_fmort,id_fmort2,id_fmelt,id_fpond,id_fpondno3,id_fpondnh4,id_fpondsil,id_fno3up,id_fsilup,id_fskelno3,id_fskelnh4,id_fskelsil,id_ier,id_lice,id_llig,id_lno3,id_lsil,id_hnu,id_fnit,id_biPAR
! Declare environmental variables
      type (type_dependency_id) :: id_ph2,id_no3SW,id_nh4SW,id_silSW,id_u,id_v
      type (type_horizontal_dependency_id) :: id_airt,id_ice_hs,id_par,id_temp,id_ice_hi,id_botmelt,id_botgrowth,id_topmelt,id_termelt,id_Amelt,id_ts 
...
contains
   ...
   ! parameters: read in vals from fabm.yaml 
   ...
   hnu      = self%nu/utaui
   fskelno3 = self%md_no3/hnu*(no3SW-no3)/self%zia+min(0.0,ier*no3/self%zia)  ! diffusion + ??
