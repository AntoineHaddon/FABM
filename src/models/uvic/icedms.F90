...
! Define the namelist
   !jpnote need to bring in vals from icealgae - same way as in eco 
#if 0
   ...
   namelist /uvic_icedms/ dmsi_0,dmspdi_0,qi,h_dmspdi,h_dmsi,k_dmspdi,k_dmsi,yieldi,k_lyi,f_exi,k_exi,k_ini,k_phoi
!  Initialize parameters to default values.
   dmsi_0   = 1.0_rk 
   dmspdi_0 = 1.0_rk     !jpnote remember to set default 
   qi       = 9.43_rk
   h_dmspdi = 3.0_rk
   h_dmsi   = 3.0_rk
   k_dmspdi = 5.7_rk
...
!icedms vars from yaml 
   call self%get_parameter(self%dmsi_0, 'dmsi_0','nmol/L','dms initial value', default=1.0_rk)
   call self%get_parameter(self%dmspdi_0 , 'dmspdi_0 ','nmol/L','dmspd initial value ', default=1.0_rk)
...
! Register diagnostic variables
      call self%register_horizontal_diagnostic_variable(self%id_dmspp,'dmspp','nmol/L','ice DMSPp')
      call self%register_horizontal_diagnostic_variable(self%id_flysspd,'flysspd','nM per day','exudation/cell lysis')
      call self%register_horizontal_diagnostic_variable(self%id_fexuspd,'fexuspd','nM per day','sloppy feeding')
      call self%register_horizontal_diagnostic_variable(self%id_fspdbac,'fspdbac','nM per day','DMSPd bacterial consumption')
      call self%register_horizontal_diagnostic_variable(self%id_fspddms,'fspddms','nM per day','extracellular lyase')      
      call self%register_horizontal_diagnostic_variable(self%id_fspdaiw,'fspdaiw','nM per day','DMSPd exchange at ice-water interface')      
      call self%register_horizontal_diagnostic_variable(self%id_fsppdms,'fsppdms','nM per day','intracellular lyase')
      call self%register_horizontal_diagnostic_variable(self%id_fbacdms,'fbacdms','nM per day','bacterial lyase (yield)')
      call self%register_horizontal_diagnostic_variable(self%id_fdmsbac,'fdmsbac','nM per day','DMS bacterial consumption')
      call self%register_horizontal_diagnostic_variable(self%id_fdmspho,'fdmspho','nM per day','photolysis')
      call self%register_horizontal_diagnostic_variable(self%id_fdmsaiw,'fdmsaiw','nM per day','DMS exchange at ice-water interface')
      call self%register_horizontal_diagnostic_variable(self%id_fspdmel,'fspdmel','nM per day','DMSPd release due to bottom ice melting')
      call self%register_horizontal_diagnostic_variable(self%id_fspdpon,'fspdpon','nM per day','DMSPd release due to meltpond drainage')
      call self%register_horizontal_diagnostic_variable(self%id_fdmsmel,'fdmsmel','nM per day','DMS release due to bottom ice melting')
      call self%register_horizontal_diagnostic_variable(self%id_fdmspon,'fdmspon','nM per day','DMS release due to meltpond drainage')
